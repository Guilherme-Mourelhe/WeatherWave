...
const init = () => {
  ...
  requestURL = `https://newsapi.org/v2/top-headlines?country=${country}&category=science&apiKey=${apiKey}`;
  getNews();  // Carrega automaticamente as notícias de ciência ao iniciar
  createOptions();
};
